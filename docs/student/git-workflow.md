...
```bash
git status
git add path/to/your-completed-change.cpp
...
```bash
git add src/statistics.cpp include/statistics.h
```
...
Run the local build and tests after staging or before committing, as required
