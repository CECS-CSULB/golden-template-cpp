...
Use the HTTPS URL for the [CECS Platforms `golden-template-cpp` repository](https://github.com/cecs-platforms/golden-template-cpp):

```bash
git clone https://github.com/cecs-platforms/golden-template-cpp.git
cd golden-template-cpp
```
